...
参考[从Hub加载模型](https://www.mindspore.cn/tutorial/training/zh-CN/r1.0/use/load_model_for_inference_and_transfer.html#hub)实现模型加载以及模型微调迁移。

## 文档

有关安装指南、教程和API的更多详细信息，请参阅[从Hub加载模型](https://www.mindspore.cn/tutorial/training/zh-CN/r1.0/use/load_model_for_inference_and_transfer.html#hub) 和 [发布模型](https://www.mindspore.cn/tutorial/training/zh-CN/r1.0/use/publish_model.html)。
