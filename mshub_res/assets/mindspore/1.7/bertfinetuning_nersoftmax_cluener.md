...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.7/bertfinetuning_nersoftmax_ascend_v170_cluener_official_nlp_acc93.75.ckpt>
...
model = "mindspore/1.7/bertfinetuning_nersoftmax_cluener"
