...
repo-link: <https://gitee.com/mindspore/models/tree/r1.7/official/cv/predrnn++>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.7/predrnnplusplus_ascend_v170_movingmnist_official_cv_mse47.9_ssim0.878.ckpt>
...
predrnn++ is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/predrnn++](https://gitee.com/mindspore/models/blob/r1.7/official/cv/predrnn++/README.md).
