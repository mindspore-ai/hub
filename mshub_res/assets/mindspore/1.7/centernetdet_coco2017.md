...
repo-link: <https://gitee.com/mindspore/models/tree/r1.7/research/cv/centernet_det>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.7/centernetdet_ascend_v170_coco2017_research_cv_mAP41.6_AP50acc60.1_AP75acc44.5.ckpt>
...
centernet_det is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/centernet_det](https://gitee.com/mindspore/models/blob/r1.7/research/cv/centernet_det/README.md).
