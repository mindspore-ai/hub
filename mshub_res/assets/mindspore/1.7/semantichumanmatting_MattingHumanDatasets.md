...
repo-link: <https://gitee.com/mindspore/models/tree/r1.7/official/cv/semantic_human_matting>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.7/semantichumanmatting_ascend_v170_MattingHumanDatasets_official_cv_avesad5.49.ckpt>
...
semantic_human_matting is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/semantic_human_matting](https://gitee.com/mindspore/models/blob/r1.7/official/cv/semantic_human_matting/README.md).
