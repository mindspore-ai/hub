...
repo-link: <https://gitee.com/mindspore/models/tree/r1.7/official/nlp/tinybert>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.7/tinybert_ascend_v170_enwiki128_sst2_official_nlp_acc90.28.ckpt>
...
tinybert is a nlp network. More details please refer to the MindSpore model zoo on Gitee at [official/nlp/tinybert](https://gitee.com/mindspore/models/blob/r1.7/official/nlp/tinybert/README.md).
...
model = "mindspore/1.7/tinybert_enwiki128_sst2"
