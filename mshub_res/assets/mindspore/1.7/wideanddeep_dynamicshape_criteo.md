...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.7/wideanddeep_dynamicshape_ascend_v170_criteo_official_recommend_acc78.88.ckpt>
...
model = "mindspore/1.7/wideanddeep_dynamicshape_criteo"
