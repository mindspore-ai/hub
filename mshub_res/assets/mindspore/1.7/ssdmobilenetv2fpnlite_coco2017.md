...
repo-link: <https://gitee.com/mindspore/models/tree/r1.7/research/cv/ssd_mobilenetV2_FPNlite>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.7/ssdmobilenetv2fpnlite_ascend_v170_coco2017_research_cv_mAP25.53.ckpt>
...
ssd_mobilenetV2_FPNlite is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/ssd_mobilenetV2_FPNlite](https://gitee.com/mindspore/models/blob/r1.7/research/cv/ssd_mobilenetV2_FPNlite/README.md).
