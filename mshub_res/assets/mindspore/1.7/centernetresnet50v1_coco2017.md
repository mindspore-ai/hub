...
repo-link: <https://gitee.com/mindspore/models/tree/r1.7/research/cv/centernet_resnet50_v1>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.7/centernetresnet50v1_ascend_v170_coco2017_research_cv_map30.7.ckpt>
...
centernet_resnet50_v1 is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/centernet_resnet50_v1](https://gitee.com/mindspore/models/blob/r1.7/research/cv/centernet_resnet50_v1/README.md).
