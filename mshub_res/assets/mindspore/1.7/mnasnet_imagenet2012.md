...
repo-link: <https://gitee.com/mindspore/models/tree/r1.7/research/cv/mnasnet>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.7/mnasnet_ascend_v170_imagenet2012_research_cv_top1acc73.98_top5acc91.68.ckpt>
...
mnasnet is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/mnasnet](https://gitee.com/mindspore/models/blob/r1.7/research/cv/mnasnet/README_CN.md).
...
model = "mindspore/1.7/mnasnet_imagenet2012"
