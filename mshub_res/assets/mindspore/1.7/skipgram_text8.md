...
repo-link: <https://gitee.com/mindspore/models/tree/r1.7/research/nlp/skipgram>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.7/skipgram_ascend_v170_text8_research_nlp_acc35.78.ckpt>
...
skipgram is a nlp network. More details please refer to the MindSpore model zoo on Gitee at [research/nlp/skipgram](https://gitee.com/mindspore/models/blob/r1.7/research/nlp/skipgram/README_CN.md).
...
model = "mindspore/1.7/skipgram_text8"
