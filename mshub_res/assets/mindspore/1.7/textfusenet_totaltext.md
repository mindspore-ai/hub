...
repo-link: <https://gitee.com/mindspore/models/tree/r1.7/research/cv/textfusenet>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.7/textfusenet_ascend_v170_totaltext_research_cv_acc82.3.ckpt>
...
textfusenet is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/textfusenet](https://gitee.com/mindspore/models/blob/r1.7/research/cv/textfusenet/README.md).
