...
repo-link: <https://gitee.com/mindspore/models/tree/r1.7/official/cv/crnn>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.7/crnn_ascend_v170_synth_official_cv_svtacc80.83_iiit5kacc79.73.ckpt>
...
crnn is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/crnn](https://gitee.com/mindspore/models/blob/r1.7/official/cv/crnn/README.md).
...
model = "mindspore/1.7/crnn_synth"
