...
repo-link: <https://gitee.com/mindspore/models/tree/r1.7/research/nlp/seq2seq>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.7/seq2seq_ascend_v170_wmt14_research_nlp_BLUE12.9.ckpt>
...
seq2seq is a nlp network. More details please refer to the MindSpore model zoo on Gitee at [research/nlp/seq2seq](https://gitee.com/mindspore/models/blob/r1.7/research/nlp/seq2seq/README_CN.md).
