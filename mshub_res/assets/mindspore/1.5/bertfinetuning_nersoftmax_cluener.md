...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/bertfinetuning_nersoftmax_ascend_v150_cluener_official_nlp_acc93.75.ckpt>
...
model = "mindspore/1.5/bertfinetuning_nersoftmax_cluener"
