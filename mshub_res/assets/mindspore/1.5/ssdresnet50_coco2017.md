...
repo-link: <https://gitee.com/mindspore/models/tree/r1.5/research/cv/ssd_resnet50>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/ssdresnet50_ascend_v150_coco2017_research_cv_acc32.2.ckpt>
...
ssd_resnet50 is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/ssd_resnet50](https://gitee.com/mindspore/models/blob/r1.5/research/cv/ssd_resnet50/README.md).
...
model = "mindspore/1.5/ssdresnet50_coco2017"
