...
repo-link: <https://gitee.com/mindspore/models/tree/r1.5/official/nlp/tinybert>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/tinybert_ascend_v150_enwiki128_qnli_official_nlp_acc88.86.ckpt>
...
tinybert is a nlp network. More details please refer to the MindSpore model zoo on Gitee at [official/nlp/tinybert](https://gitee.com/mindspore/models/blob/r1.5/official/nlp/tinybert/README.md).
...
model = "mindspore/1.5/tinybert_enwiki128_qnli"
