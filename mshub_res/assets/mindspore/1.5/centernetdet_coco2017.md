...
repo-link: <https://gitee.com/mindspore/models/tree/r1.5/research/cv/centernet_det>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/centernetdet_ascend_v150_coco2017_research_cv_mAP41.5_AP50acc59.8_AP75acc59.8.ckpt>
...
centernet_det is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/centernet_det](https://gitee.com/mindspore/models/blob/r1.5/research/cv/centernet_det/README.md).
