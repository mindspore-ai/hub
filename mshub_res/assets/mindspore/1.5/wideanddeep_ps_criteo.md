...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/wideanddeep_ps_ascend_v150_criteo_official_recommend_acc80.76.ckpt>
...
model = "mindspore/1.5/wideanddeep_ps_criteo"
