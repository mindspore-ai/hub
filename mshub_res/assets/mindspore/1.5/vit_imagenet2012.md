...
repo-link: <https://gitee.com/mindspore/models/tree/r1.5/official/cv/vit>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/vit_ascend_v150_imagenet2012_official_cv_acc74.17.ckpt>
...
vit is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/vit](https://gitee.com/mindspore/models/blob/r1.5/official/cv/vit/README.md).
...
model = "mindspore/1.5/vit_imagenet2012"
