...
repo-link: <https://gitee.com/mindspore/models/tree/r1.5/official/nlp/gru>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/gru_ascend_v150_muti30k_official_nlp_acc30.ckpt>
...
gru is a nlp network. More details please refer to the MindSpore model zoo on Gitee at [official/nlp/gru](https://gitee.com/mindspore/models/blob/r1.5/official/nlp/gru/README.md).
...
model = "mindspore/1.5/gru_muti30k"
