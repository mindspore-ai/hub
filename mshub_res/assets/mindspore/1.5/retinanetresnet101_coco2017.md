...
repo-link: <https://gitee.com/mindspore/models/tree/r1.5/research/cv/retinanet_resnet101>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/retinanetresnet101_ascend_v150_coco2017_research_cv_acc36.39.ckpt>
...
retinanet_resnet101 is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/retinanet_resnet101](https://gitee.com/mindspore/models/blob/r1.5/research/cv/retinanet_resnet101/README_CN.md).
