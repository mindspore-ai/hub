...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/bertfinetuning_classifier_ascend_v150_cola_official_nlp_acc55.71.ckpt>
...
model = "mindspore/1.5/bertfinetuning_classifier_cola"
