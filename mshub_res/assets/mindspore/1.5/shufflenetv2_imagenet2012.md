...
repo-link: <https://gitee.com/mindspore/models/tree/r1.5/official/cv/shufflenetv2>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/shufflenetv2_ascend_v150_imagenet2012_official_cv_top1acc69.63_top5acc88.72.ckpt>
...
shufflenetv2 is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/shufflenetv2](https://gitee.com/mindspore/models/blob/r1.5/official/cv/shufflenetv2/README.md).
...
model = "mindspore/1.5/shufflenetv2_imagenet2012"
