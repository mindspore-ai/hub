...
repo-link: <https://gitee.com/mindspore/models/tree/r1.5/official/cv/retinanet>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/retinanet_ascend_v150_coco2017_official_cv_acc35.ckpt>
...
retinanet is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/retinanet](https://gitee.com/mindspore/models/blob/r1.5/official/cv/retinanet/README_CN.md).
...
model = "mindspore/1.5/retinanet_coco2017"
