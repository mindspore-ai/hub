...
repo-link: <https://gitee.com/mindspore/models/tree/r1.5/official/cv/alexnet>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/alexnet_ascend_v150_imagenet2012_official_cv_top1acc57.45_top5acc80.ckpt>
...
alexnet is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/alexnet](https://gitee.com/mindspore/models/blob/r1.5/official/cv/alexnet/README.md).
...
model = "mindspore/1.5/alexnet_imagenet2012"
