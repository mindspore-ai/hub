...
repo-link: <https://gitee.com/mindspore/models/tree/r1.5/research/cv/ntsnet>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/ntsnet_ascend_v150_cub2002011_research_cv_acc87.ckpt>
...
ntsnet is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/ntsnet](https://gitee.com/mindspore/models/blob/r1.5/research/cv/ntsnet/README.md).
...
model = "mindspore/1.5/ntsnet_cub2002011"
