...
repo-link: <https://gitee.com/mindspore/models/tree/r1.5/research/cv/autoaugment>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/autoaugment_ascend_v150_cifar10_research_cv_acc97.22.ckpt>
...
autoaugment is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/autoaugment](https://gitee.com/mindspore/models/blob/r1.5/research/cv/autoaugment/README_CN.md).
...
model = "mindspore/1.5/autoaugment_cifar10"
