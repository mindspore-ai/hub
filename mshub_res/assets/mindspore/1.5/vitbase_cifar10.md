...
repo-link: <https://gitee.com/mindspore/models/tree/r1.5/research/cv/vit_base>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/vitbase_ascend_v150_cifar10_research_cv_acc98.71.ckpt>
...
vit_base is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/vit_base](https://gitee.com/mindspore/models/blob/r1.5/research/cv/vit_base/README_CN.md).
