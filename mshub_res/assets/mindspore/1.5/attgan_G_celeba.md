...
repo-link: <https://gitee.com/mindspore/models/tree/r1.5/research/cv/AttGAN>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/attgan_G_ascend_v150_celeba_research_cv.ckpt>
...
AttGAN is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/AttGAN](https://gitee.com/mindspore/models/blob/r1.5/research/cv/AttGAN/README_CN.md).
