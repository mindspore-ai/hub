...
repo-link: <https://gitee.com/mindspore/models/tree/r1.5/official/recommend/tbnet>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/tbnet_ascend_v150_steam_official_recommend_auc81.00.ckpt>
...
tbnet is a recommend network. More details please refer to the MindSpore model zoo on Gitee at [official/recommend/tbnet](https://gitee.com/mindspore/models/blob/r1.5/official/recommend/tbnet/README.md).
