...
repo-link: <https://gitee.com/mindspore/models/tree/r1.5/official/cv/faster_rcnn>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/fasterrcnnresnetv150_ascend_v150_coco2017_official_cv_mAP@.5IoU60.6.ckpt>
...
faster_rcnn is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/faster_rcnn](https://gitee.com/mindspore/models/blob/r1.5/official/cv/faster_rcnn/README.md).
...
model = "mindspore/1.5/fasterrcnnresnetv150_coco2017"
