...
repo-link: <https://gitee.com/mindspore/models/tree/r1.5/research/cv/ssd_mobilenetV2>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.5/ssdmobilenetv2_ascend_v150_coco2017_research_cv_acc24.ckpt>
...
ssd_mobilenetV2 is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/ssd_mobilenetV2](https://gitee.com/mindspore/models/blob/r1.5/research/cv/ssd_mobilenetV2/README.md).
