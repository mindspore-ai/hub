...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.10/unetnested_ascend_v1100_cellnuclei_official_cv_iou93.00.ckpt>
...
model = "mindspore/1.10/unetnested_cellnuclei"
