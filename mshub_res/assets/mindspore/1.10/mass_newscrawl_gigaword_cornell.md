...
repo-link: <https://gitee.com/mindspore/models/tree/r1.10/official/nlp/mass>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.10/mass_ascend_v1100_newscrawl_gigaword_cornell_official_nlp_RG1acc51.77_RG2acc34.46_RGL49.89.ckpt>
...
mass is a nlp network. More details please refer to the MindSpore model zoo on Gitee at [official/nlp/mass](https://gitee.com/mindspore/models/blob/r1.10/official/nlp/mass/README.md).
...
model = "mindspore/1.10/mass_newscrawl_gigaword_cornell"
