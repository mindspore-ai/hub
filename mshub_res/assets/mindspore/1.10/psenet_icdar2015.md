...
repo-link: <https://gitee.com/mindspore/models/tree/r1.10/official/cv/psenet>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.10/psenet_ascend_v1100_icdar2015_official_cv_acc81.ckpt>
...
psenet is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/psenet](https://gitee.com/mindspore/models/blob/r1.10/official/cv/psenet/README.md).
...
model = "mindspore/1.10/psenet_icdar2015"
