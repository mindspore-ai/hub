...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.10/bertfinetune_crf_ascend_v1100_cluener_official_nlp_acc91.87.ckpt>
...
model = "mindspore/1.10/bertfinetune_crf_cluener"
