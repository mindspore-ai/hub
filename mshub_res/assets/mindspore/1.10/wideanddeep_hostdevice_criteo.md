...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.10/wideanddeep_hostdevice_ascend_v1100_criteo_official_recommend_acc79.34.ckpt>
...
model = "mindspore/1.10/wideanddeep_hostdevice_criteo"
