...
repo-link: <https://gitee.com/mindspore/models/tree/r1.10/research/cv/ghostnet_quant>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.10/ghostnetquant_ascend_v1100_imagenet2012_research_cv_top1acc82.5.ckpt>
...
ghostnet_quant is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/ghostnet_quant](https://gitee.com/mindspore/models/blob/r1.10/research/cv/ghostnet_quant/Readme.md).
