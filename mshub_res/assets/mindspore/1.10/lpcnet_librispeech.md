...
repo-link: <https://gitee.com/mindspore/models/tree/r1.10/official/audio/lpcnet>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.10/lpcnet_ascend_v1100_librispeech_official_audio_MSE0.34.ckpt>
...
lpcnet is a audio network. More details please refer to the MindSpore model zoo on Gitee at [official/audio/lpcnet](https://gitee.com/mindspore/models/blob/r1.10/official/audio/lpcnet/README.md).
