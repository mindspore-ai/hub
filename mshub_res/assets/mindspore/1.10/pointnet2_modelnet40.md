...
repo-link: <https://gitee.com/mindspore/models/tree/r1.10/research/cv/pointnet2>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.10/pointnet2_ascend_v1100_modelnet40_research_cv_acc91.83.ckpt>
...
pointnet2 is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/pointnet2](https://gitee.com/mindspore/models/blob/r1.10/research/cv/pointnet2/README.md).
