...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.10/wideanddeep_dynamicshape_ascend_v1100_criteo_official_recommend_acc78.88.ckpt>
...
model = "mindspore/1.10/wideanddeep_dynamicshape_criteo"
