...
repo-link: <https://gitee.com/mindspore/models/tree/r1.10/research/nlp/textrcnn>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.10/textcrnn_lstm_ascend_v1100_polarity_moviereview_research_nlp_acc80.76.ckpt>
...
textrcnn is a nlp network. More details please refer to the MindSpore model zoo on Gitee at [research/nlp/textrcnn](https://gitee.com/mindspore/models/blob/r1.10/research/nlp/textrcnn/README.md).
...
model = "mindspore/1.10/textcrnn_lstm_polarity_moviereview"
