...
repo-link: <https://gitee.com/mindspore/models/tree/r1.10/research/cv/SinGAN>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.10/singan_G_ascend_v1100_asinglenatureimage_research_cv.ckpt>
...
SinGAN is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/SinGAN](https://gitee.com/mindspore/models/blob/r1.10/research/cv/SinGAN/README.md).
