...
repo-link: <https://gitee.com/mindspore/models/tree/r1.10/research/cv/pointnet>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.10/pointnet_ascend_v1100_shapenet_research_cv_acc86.96.ckpt>
...
pointnet is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/pointnet](https://gitee.com/mindspore/models/blob/r1.10/research/cv/pointnet/README.md).
