...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.10/textcrnn_gru_ascend_v1100_polarity_moviereview_research_nlp_acc81.05.ckpt>
...
model = "mindspore/1.10/textcrnn_gru_polarity_moviereview"
