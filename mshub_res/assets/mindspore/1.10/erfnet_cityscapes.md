...
repo-link: <https://gitee.com/mindspore/models/tree/r1.10/official/cv/erfnet>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.10/erfnet_ascend_v1100_cityscapes_official_cv_acc70.73.ckpt>
...
erfnet is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/erfnet](https://gitee.com/mindspore/models/blob/r1.10/official/cv/erfnet/README_CN.md).
