...
repo-link: <https://gitee.com/mindspore/models/tree/r1.9/research/cv/centernet>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.9/centernet_ascend_v190_coco2017_research_cv_mAP52.2.ckpt>
...
centernet is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/centernet](https://gitee.com/mindspore/models/blob/r1.9/research/cv/centernet/README.md).
...
model = "mindspore/1.9/centernet_coco2017"
