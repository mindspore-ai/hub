...
repo-link: <https://gitee.com/mindspore/models/tree/r1.9/official/nlp/gnmt_v2>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.9/gnmtv2_ascend_v190_wmtende_official_nlp_acc24.ckpt>
...
gnmt_v2 is a nlp network. More details please refer to the MindSpore model zoo on Gitee at [official/nlp/gnmt_v2](https://gitee.com/mindspore/models/blob/r1.9/official/nlp/gnmt_v2/README.md).
...
model = "mindspore/1.9/gnmtv2_wmtende"
