...
repo-link: <https://gitee.com/mindspore/models/tree/r1.9/official/cv/ssd>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.9/ssdmobilenetv1fpn_ascend_v190_coco2017_official_cv_acc35.11.ckpt>
...
ssd is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/ssd](https://gitee.com/mindspore/models/blob/r1.9/official/cv/ssd/README.md).
...
model = "mindspore/1.9/ssdmobilenetv1fpn_coco2017"
