...
repo-link: <https://gitee.com/mindspore/models/tree/r1.9/official/recommend/ncf>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.9/ncf_ascend_v190_movielens_official_recommend_hr69.56_ndcg41.54.ckpt>
...
ncf is a recommend network. More details please refer to the MindSpore model zoo on Gitee at [official/recommend/ncf](https://gitee.com/mindspore/models/blob/r1.9/official/recommend/ncf/README.md).
...
model = "mindspore/1.9/ncf_movielens"
