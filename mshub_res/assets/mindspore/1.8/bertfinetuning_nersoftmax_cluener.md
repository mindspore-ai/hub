...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.8/bertfinetuning_nersoftmax_ascend_v180_cluener_official_nlp_acc93.75.ckpt>
...
model = "mindspore/1.8/bertfinetuning_nersoftmax_cluener"
