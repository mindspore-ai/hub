...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.8/bertfinetune_crf_ascend_v180_cluener_official_nlp_acc91.87.ckpt>
...
model = "mindspore/1.8/bertfinetune_crf_cluener"
