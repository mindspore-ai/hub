...
vit is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/vit](https://gitee.com/mindspore/models/blob/r1.8/official/cv/vit/README.md).
...
model = "mindspore/1.8/vit_imagenet2012"
