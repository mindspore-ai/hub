...
repo-link: <https://gitee.com/mindspore/models/tree/r1.8/research/cv/ManiDP>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.8/manidp_ascend_v180_cifar10_research_cv_acc92.0.ckpt>
...
ManiDP is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/ManiDP](https://gitee.com/mindspore/models/blob/r1.8/research/cv/ManiDP/Readme.md).
