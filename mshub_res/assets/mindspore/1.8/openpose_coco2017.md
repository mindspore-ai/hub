...
repo-link: <https://gitee.com/mindspore/models/tree/r1.8/official/cv/openpose>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.8/openpose_ascend_v180_coco2017_official_cv_mAP40.29.ckpt>
...
openpose is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/openpose](https://gitee.com/mindspore/models/blob/r1.8/official/cv/openpose/README.md).
...
model = "mindspore/1.8/openpose_coco2017"
