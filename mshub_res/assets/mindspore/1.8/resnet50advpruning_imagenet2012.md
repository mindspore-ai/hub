...
repo-link: <https://gitee.com/mindspore/models/tree/r1.8/research/cv/resnet50_adv_pruning>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.8/resnet50advpruning_ascend_v180_imagenet2012_research_cv_top1acc80.2.ckpt>
...
resnet50_adv_pruning is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/resnet50_adv_pruning](https://gitee.com/mindspore/models/blob/r1.8/research/cv/resnet50_adv_pruning/Readme.md).
