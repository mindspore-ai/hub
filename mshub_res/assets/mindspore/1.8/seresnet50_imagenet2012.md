...
repo-link: <https://gitee.com/mindspore/models/tree/r1.8/official/cv/resnet>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.8/seresnet50_ascend_v180_imagenet2012_official_cv_top1acc76.75_top5acc93.43.ckpt>
...
resnet is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/resnet](https://gitee.com/mindspore/models/blob/r1.8/official/cv/resnet/README.md).
...
model = "mindspore/1.8/seresnet50_imagenet2012"
