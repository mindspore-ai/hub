...
repo-link: <https://gitee.com/mindspore/models/tree/r1.8/research/cv/STGAN>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.8/stgan_ascend_v180_celeba_research_cv.ckpt>
...
STGAN is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/STGAN](https://gitee.com/mindspore/models/blob/r1.8/research/cv/STGAN/README.md).
