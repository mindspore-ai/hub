...
repo-link: <https://gitee.com/mindspore/models/tree/r1.8/official/cv/xception>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.8/xception_ascend_v180_imagenet2012_official_cv_top1acc79.94_top5acc94.97.ckpt>
...
xception is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/xception](https://gitee.com/mindspore/models/blob/r1.8/official/cv/xception/README.md).
...
model = "mindspore/1.8/xception_imagenet2012"
