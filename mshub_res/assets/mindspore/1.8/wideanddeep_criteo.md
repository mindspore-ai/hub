...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.8/wideanddeep_ascend_v180_criteo_official_recommend_acc80.8.ckpt>
...
model = "mindspore/1.8/wideanddeep_criteo"
