...
repo-link: <https://gitee.com/mindspore/models/tree/r1.8/official/gnn/bgcf>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.8/bgcf_ascend_v180_amazonbeauty_official_gnn_recall20acc15.32_ndcg20acc9.16.ckpt>
...
bgcf is a gnn network. More details please refer to the MindSpore model zoo on Gitee at [official/gnn/bgcf](https://gitee.com/mindspore/models/blob/r1.8/official/gnn/bgcf/README.md).
...
model = "mindspore/1.8/bgcf_amazonbeauty"
