...
repo-link: <https://gitee.com/mindspore/models/tree/r1.6/research/cv/res2net_faster_rcnn>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.6/res2netfasterrcnn_ascend_v160_coco2017_research_cv_mAP40.ckpt>
...
res2net_faster_rcnn is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/res2net_faster_rcnn](https://gitee.com/mindspore/models/blob/r1.6/research/cv/res2net_faster_rcnn/README.md).
...
model = "mindspore/1.6/res2netfasterrcnn_coco2017"
