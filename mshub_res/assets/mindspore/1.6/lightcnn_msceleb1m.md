...
repo-link: <https://gitee.com/mindspore/models/tree/r1.6/research/cv/LightCNN>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.6/lightcnn_ascend_v160_msceleb1m_research_cv.ckpt>
...
LightCNN is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/LightCNN](https://gitee.com/mindspore/models/blob/r1.6/research/cv/LightCNN/README_CN.md).
