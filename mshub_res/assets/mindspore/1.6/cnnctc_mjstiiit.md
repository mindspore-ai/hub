...
repo-link: <https://gitee.com/mindspore/models/tree/r1.6/official/cv/cnnctc>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.6/cnnctc_ascend_v160_mjstiiit_official_cv_acc85.97.ckpt>
...
cnnctc is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/cnnctc](https://gitee.com/mindspore/models/blob/r1.6/official/cv/cnnctc/README.md).
...
model = "mindspore/1.6/cnnctc_mjstiiit"
