...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.6/bertfinetuning_classifier_ascend_v160_cola_official_nlp_acc55.71.ckpt>
...
model = "mindspore/1.6/bertfinetuning_classifier_cola"
