...
repo-link: <https://gitee.com/mindspore/models/tree/r1.6/research/cv/HourNAS>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.6/hournas_ascend_v160_cifar10_research_cv_top1acc96.1.ckpt>
...
HourNAS is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/HourNAS](https://gitee.com/mindspore/models/blob/r1.6/research/cv/HourNAS/README.md).
