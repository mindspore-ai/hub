...
repo-link: <https://gitee.com/mindspore/models/tree/r1.6/official/audio/melgan>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.6/melgan_ascend_v160_ljspeech_official_audio.ckpt>
...
melgan is a audio network. More details please refer to the MindSpore model zoo on Gitee at [official/audio/melgan](https://gitee.com/mindspore/models/blob/r1.6/official/audio/melgan/README.md).
