...
repo-link: <https://gitee.com/mindspore/models/tree/r1.6/research/cv/APDrawingGAN>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.6/apdrawinggan_generator_ascend_v160_apdrawingdb_research_cv.ckpt>
...
APDrawingGAN is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/APDrawingGAN](https://gitee.com/mindspore/models/blob/r1.6/research/cv/APDrawingGAN/README_CN.md).
