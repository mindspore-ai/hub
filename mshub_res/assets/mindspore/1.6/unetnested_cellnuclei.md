...
repo-link: <https://gitee.com/mindspore/models/tree/r1.6/official/cv/unet>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.6/unetnested_ascend_v160_cellnuclei_official_cv_iou93.00.ckpt>
...
unet is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/unet](https://gitee.com/mindspore/models/blob/r1.6/official/cv/unet/README.md).
...
model = "mindspore/1.6/unetnested_cellnuclei"
