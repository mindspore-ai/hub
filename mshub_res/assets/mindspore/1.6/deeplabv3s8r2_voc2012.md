...
repo-link: <https://gitee.com/mindspore/models/tree/r1.6/official/cv/deeplabv3>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.6/deeplabv3s8r2_ascend_v160_voc2012_official_cv_s8acc78.51_ns8mul79.26_ns8mulflip79.37.ckpt>
...
deeplabv3 is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/deeplabv3](https://gitee.com/mindspore/models/blob/r1.6/official/cv/deeplabv3/README.md).
...
model = "mindspore/1.6/deeplabv3s8r2_voc2012"
