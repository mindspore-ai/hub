...
repo-link: <https://gitee.com/mindspore/models/tree/r1.6/official/nlp/duconv>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.6/duconv_ascend_v160_duconv_official_nlp_F1score31.71.ckpt>
...
duconv is a nlp network. More details please refer to the MindSpore model zoo on Gitee at [official/nlp/duconv](https://gitee.com/mindspore/models/blob/r1.6/official/nlp/duconv/README_CN.md).
