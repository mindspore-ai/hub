...
repo-link: <https://gitee.com/mindspore/models/tree/r1.6/official/cv/centerface>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.6/centerface_ascend_v160_widerface_official_cv_easy92.4_medium91.7_hard77.9.ckpt>
...
centerface is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/centerface](https://gitee.com/mindspore/models/blob/r1.6/official/cv/centerface/README.md).
...
model = "mindspore/1.6/centerface_widerface"
