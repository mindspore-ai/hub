...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.6/bertfinetuning_nersoftmax_ascend_v160_cluener_official_nlp_acc93.75.ckpt>
...
model = "mindspore/1.6/bertfinetuning_nersoftmax_cluener"
