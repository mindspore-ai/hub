...
repo-link: <https://gitee.com/mindspore/models/tree/r1.6/research/nlp/albert>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.6/albert_ascend_v160_squadv1.1_research_nlp_exactmatch80.88_F1score88.71.ckpt>
...
albert is a nlp network. More details please refer to the MindSpore model zoo on Gitee at [research/nlp/albert](https://gitee.com/mindspore/models/blob/r1.6/research/nlp/albert/README.md).
