...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.6/textcrnn_gru_ascend_v160_polarity_moviereview_research_nlp_acc81.05.ckpt>
...
model = "mindspore/1.6/textcrnn_gru_polarity_moviereview"
