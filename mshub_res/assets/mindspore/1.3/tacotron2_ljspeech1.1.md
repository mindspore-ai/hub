...
repo-link: <https://gitee.com/mindspore/models/tree/r1.3/research/audio/tacotron2>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.3/tacotron2_ascend_v130_ljspeech1.1_research_audio.ckpt>
...
tacotron2 is a audio network. More details please refer to the MindSpore model zoo on Gitee at [research/audio/tacotron2](https://gitee.com/mindspore/models/blob/r1.3/research/audio/tacotron2/README.md).
