...
repo-link: <https://gitee.com/mindspore/models/tree/r1.3/official/cv/shufflenetv2>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.3/shufflenetv2_ascend_v130_imagenet2012_official_cv_top1acc69.63_top5acc88.72.ckpt>
...
shufflenetv2 is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/shufflenetv2](https://gitee.com/mindspore/models/blob/r1.3/official/cv/shufflenetv2/README.md).
...
model = "mindspore/1.3/shufflenetv2_imagenet2012"
