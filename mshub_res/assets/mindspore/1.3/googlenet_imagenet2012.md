...
repo-link: <https://gitee.com/mindspore/models/tree/r1.3/official/cv/googlenet>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.3/googlenet_ascend_v130_imagenet2012_official_cv_top1acc72.97_top5acc90.97.ckpt>
...
googlenet is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/googlenet](https://gitee.com/mindspore/models/blob/r1.3/official/cv/googlenet/README.md).
...
model = "mindspore/1.3/googlenet_imagenet2012"
