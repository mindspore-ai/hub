...
repo-link: <https://gitee.com/mindspore/models/tree/r1.3/official/cv/ctpn>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.3/ctpn_ascend_v130_icdar2013_official_cv_precision90_recall86_Fmeasure88.ckpt>
...
ctpn is a cv network. More details please refer to the MindSpore model zoo on Gitee at [official/cv/ctpn](https://gitee.com/mindspore/models/blob/r1.3/official/cv/ctpn/README.md).
...
model = "mindspore/1.3/ctpn_icdar2013"
