...
repo-link: <https://gitee.com/mindspore/models/tree/r1.3/research/cv/tsm>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.3/tsm_ascend_v130_somethingsomethingv2_research_cv_top1acc58.0_top5acc85.0.ckpt>
...
tsm is a cv network. More details please refer to the MindSpore model zoo on Gitee at [research/cv/tsm](https://gitee.com/mindspore/models/blob/r1.3/research/cv/tsm/README_CN.md).
