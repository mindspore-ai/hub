...
repo-link: <https://gitee.com/mindspore/models/tree/r1.3/research/nlp/rotate>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.3/rotate_ascend_v130_wn18rr_research_nlp_MRR47_MR3340_HITS@1acc42_HITS@3acc49_HITS@10acc57.ckpt>
...
rotate is a nlp network. More details please refer to the MindSpore model zoo on Gitee at [research/nlp/rotate](https://gitee.com/mindspore/models/blob/r1.3/research/nlp/rotate/README_CN.md).
