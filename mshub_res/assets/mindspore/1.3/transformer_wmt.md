...
repo-link: <https://gitee.com/mindspore/models/tree/r1.3/official/nlp/transformer>
...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.3/transformer_ascend_v130_wmt_official_nlp_acc27.21.ckpt>
...
transformer is a nlp network. More details please refer to the MindSpore model zoo on Gitee at [official/nlp/transformer](https://gitee.com/mindspore/models/blob/r1.3/official/nlp/transformer/README.md).
...
model = "mindspore/1.3/transformer_wmt"
