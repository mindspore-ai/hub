...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.3/wideanddeep_hostdevice_ascend_v130_criteo_official_recommend_acc79.34.ckpt>
...
model = "mindspore/1.3/wideanddeep_hostdevice_criteo"
