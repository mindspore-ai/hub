...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.3/textcrnn_lstm_ascend_v130_polarity_moviereview_research_nlp_acc80.76.ckpt>
...
model = "mindspore/1.3/textcrnn_lstm_polarity_moviereview"
