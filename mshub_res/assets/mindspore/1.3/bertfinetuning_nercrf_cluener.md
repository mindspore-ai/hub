...
-
    file-format: ckpt
    asset-link: <https://download.mindspore.cn/models/r1.3/bertfinetuning_nercrf_ascend_v130_cluener_official_nlp_acc92.48.ckpt>
...
model = "mindspore/1.3/bertfinetuning_nercrf_cluener"
