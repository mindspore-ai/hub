...
repo-link: <https://github.com/mindspore-lab/mindcv/tree/v0.5.0/configs/nasnet>
...
In conclusion, NasNet could achieve better model performance with fewer model parameters and fewer computation cost on image classification
