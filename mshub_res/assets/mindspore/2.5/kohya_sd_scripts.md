...
summary: Kohya SD Scripts is a collection of training scripts for Stable Diffusion models
...
The scripts work on Ascend Atlas 800T A2 machines.
...
export dataConfig="path_to/dataset_config_finetune.toml"
