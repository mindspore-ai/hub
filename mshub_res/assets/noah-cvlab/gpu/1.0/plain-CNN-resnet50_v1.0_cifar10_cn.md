...
- 文件格式：.mslite  
  资源链接： <https://download.mindspore.cn/model_zoo/official/lite/residual_distill_lite/residual_distill_res50_cifar10_bs_1_update.ms>  
  资源SHA256校验码： 449498ecf5201d46d4eaee2754d69db89b656573f4e74ab42a9f8597299bb63b

许可证：Apache 2.0

摘要：使用残差蒸馏法推导出ResNet50-plain对CIFAR-10的10个类进行分类。

---

## 简介

该MindSpore Hub模型使用ResNet50残差蒸馏实现。
